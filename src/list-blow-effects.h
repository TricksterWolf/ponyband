...
RBE(LOSE_STR,	0,		20,		"reduce honesty")
RBE(LOSE_INT,	0,		20,		"reduce magic")
RBE(LOSE_WIS,	0,		20,		"reduce laughter")
RBE(LOSE_DEX,	0,		20,		"reduce loyalty")
RBE(LOSE_CON,	0,		30,		"reduce generosity")
RBE(LOSE_CHA,	0,		20,		"reduce kindness")
